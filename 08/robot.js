// As I was pressed for time, I am using Daniel's robot.js from last year for my implementation
// https://gist.github.com/haehn/be53b912d4beae85f678c963e5b4a3df#file-robot-js-L23

// Inspired by class lecture 11/16
...
Robot = function(x, y, z) {
  ...
  Robot.prototype.onStep = function() {
    ...
    // inspired by alvin688's implementation of part 8
    for (var i in robots) {
      i = robots[i];
