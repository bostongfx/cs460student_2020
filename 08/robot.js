Robot = function(x, y, z) {
  ...
  this.right_hand.position.y = -5;  //this doesnt work
...
// for this part I was having trouble with the boundaries and how to check the robots constantly, so I used sg9293's idea since it seemed
...
Robot.prototype.onAnimate = function() {
  ...
  if (this.movement == 'raise left arm') {
    ...
    var T = -Math.PI/4; // left upper leg move forward
    ...
    var T = -Math.PI/4; // right upper leg move forward
    this.right_upperleg.quaternion.slerp( new THREE.Quaternion( Math.sin( T / 2 ),   // x
                                                                0,                   // y
                                                                0,                   // z
                                                                Math.cos( T / 2 ) ), // w
