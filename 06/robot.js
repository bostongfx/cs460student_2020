...
Robot.prototype.onAnimate = function() {
  ...
  if ( this.movement == 'raise left arm' ) {
    ...
    T = Math.PI; // 180 degrees -- doesnt matter here.
    x = 0;
    y = 0;
    z = 0;
    ...
    T = -Math.PI/2; // 180 degrees -- doesnt matter here.
      x = 0;
      y = 0;
      z = 0;
    ...
    moves = [this.right_upper_arm.quaternion.w,
            this.right_lower_arm.quaternion.w,
            this.left_upper_arm.quaternion.w,
            this.left_lower_arm.quaternion.w,
            this.right_upper_leg.quaternion.w,
            this.right_lower_leg.quaternion.w,
            this.left_upper_leg.quaternion.w,
            this.left_lower_leg.quaternion.w,
    ];
