Robot = function(x, y, z) {
  ...
  // head, neck, torso
  [geometry, material, bones] = HELPER.cylinderSkeletonMesh(3,4,'grey')
...
// face
  ...
  var face_material = new THREE.MeshStandardMaterial( {
    ...
    flatShading: true,
    map: new THREE.TextureLoader().load( 'face.jpg' )
  } );

  this.face_mesh = new THREE.SkinnedMesh( new THREE.SphereBufferGeometry(  10, 60, 80 ), face_material );
  var skeleton = new THREE.Skeleton( bones );
  ...
  //arms
  //left
  [geometry_arms, material_arms, bones_arms] = HELPER.cylinderSkeletonMesh(3,4,'red')
  ...
  [geometry_arms, material_arms, bones_arms] = HELPER.cylinderSkeletonMesh(3,4,'blue')
